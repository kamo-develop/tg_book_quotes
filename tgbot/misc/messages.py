...
class Messages:
    ...
    def get_first_greeting(full_name):
        return f"Здравствуйте, {full_name}! 😊\n\n" \
               f"Любите читать книги? Или не очень? Это не важно 🤭\n" \
               f"У нас понравится всем!\n\n" \
               f"👉 Добро пожаловать в бот с самыми интересными цитатами из книг!\n\n" \
               f"Не забывайте ставить 👍 или 👎, и мы будем подбирать для Вас книги и цитаты на основе Ваших предпочтений."
